...
class DircheckAction extends IniAction{
    ...
    public function index() {
        ...
        $dirs[]=array('dir'=>'./Apps','iswrite'=>$this->dir_writeable('./Apps'));
		$dirs[]=array('dir'=>'./api/uc_client','iswrite'=>$this->dir_writeable('./api/uc_client'));
